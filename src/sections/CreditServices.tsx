      ...
      <section className="relative min-h-screen w-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Pareja revisando documentos de crédito con asesor financiero"
            fill
            sizes="100vw"
        ...
        >
          ...
          <p className="text-[#4A5568] text-[clamp(14px,1.1vw,17px)] leading-relaxed mb-6">
            Evaluamos tu historial, identificamos errores y construimos un plan
        ...
        >
          ...
          <p className="text-[#A9B1C0] text-sm leading-relaxed">
            Seguimiento mensual y ajustes para mantener el progreso. Nuestros
            clientes ven mejoras en promedio en 45 días.
          </p>
        </div>
      </section>
    </AnimateOnView>
